...
function BlogListView({blogData}) {
    ...
    return (
        <div className='blog-container border rounded d-flex flex-column pointer mx-3 my-3' style={{ minWidth: "300px", maxWidth: "300px", height: "auto" }} onClick={()=>{
            ...
            <h4 className='my-3 mx-3 font-primary txt-primary'>{blogData?.title}</h4>
